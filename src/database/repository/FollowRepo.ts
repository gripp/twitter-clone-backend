...
export default class FollowRepo {
  public static async create(
    ...
    const follower = await FollowModel.findOne({ follower: followerId, followee: followeeId })
      .lean<Follow>()
      .exec();
    if (follower != null) throw new InternalError('Already following');
  ...
  public static async remove(
    ...
    if (fToRemove == null) throw new InternalError('Not following');
